        ...
        <Row className="home reveal">
            ...
            <Col className="homeCol">
                ...
                <div className="homeBelowButton">
                    <div className="">Get yours on <a href="https://testnets.opensea.io/collection/mystery-box-jofowta4dh" target="_blank">OpenSea</a> using your <span style={{fontWeight: "bold", color: "white", fontStyle: "italic"}}>credit card.</span></div>
                    {!account ? (
                        <div className="mt-3">
